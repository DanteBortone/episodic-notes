...
@interface BWCalendarSplitView (BWSVPrivate)
...
@implementation BWCalendarSplitView
...
+ (void)initialize;
{
  ...
  gradient           = [[NSGradient alloc] initWithStartingColor:gradientStartColor endingColor:gradientEndColor];
	...
	NSBundle *bundle = [NSBundle bundleForClass:[BWCalendarSplitView class]];
...
- (void)drawGradientDividerInRect:(NSRect)aRect
{
  NSLog(@"drawGradientDividerInRect");
...
- (BOOL)collapsibleSubviewIsCollapsed;
{
  NSLog(@"collapsibleSubviewIsCollapsed");
...
{
  NSLog(@"setCollapsibleSubviewCollapsedHelper");
...
{
  NSLog(@"setCollapsibleSubviewCollapsed");
...
{
  NSLog(@"setMinSizeForCollapsibleSubview");
...
{
  NSLog(@"removeMinSizeForCollapsibleSubview");
...
{
  NSLog(@"restoreAutoresizesSubviews");
...
{
  NSLog(@"shouldHideDividerAtIndex");
...
{
  NSLog(@"additionalEffectiveRectOfDividerAtIndex");
...
{
  NSLog(@"shouldCollapseSubview:forDoubleClickOnDividerAtIndex");
...
{
  NSLog(@"effectiveRect:forDrawnRect:ofDividerAtIndex");
...
- (void)splitViewDidResizeSubviews:(NSNotification *)aNotification
{
  NSLog(@"splitViewDidResizeSubviews");
   ...
   //BOOL isCollapsed = [[[NSUserDefaults standardUserDefaults] objectForKey:userDefaultHiddenStateKey] boolValue];
...
- (void)recalculatePreferredProportionsAndSizes;
{
  NSLog(@"recalculatePreferredProportionsAndSizes");
...
- (BOOL)validatePreferredProportionsAndSizes;
{
  NSLog(@"validatePreferredProportionsAndSizes");
...
{
  NSLog(@"correctCollapsiblePreferredProportionOrSize");
...
- (void)validateAndCalculatePreferredProportionsAndSizes;
{
  NSLog(@"validateAndCalculatePreferredProportionsAndSizes");
...
- (void)clearPreferredProportionsAndSizes;
{
  NSLog(@"clearPreferredProportionsAndSizes");
...
- (void)splitView:(NSSplitView *)sender resizeSubviewsWithOldSize:(NSSize)oldSize
{
  NSLog(@"resizeSubviewsWithOldSize");
   ...
   if ([secondaryDelegate respondsToSelector:@selector(splitView:resizeSubviewsWithOldSize:)])
   {
